...
const promptPath = join(projectDir, "prompts", "roman-world-visual-proof-grid-nb2-2k.txt");
const characterReferencePath = join(
	projectDir,
	"assets",
	"characters",
	"skeleton-engineer-character-sheet-v4-nb2-2k.jpg",
);
const outputPath = join(projectDir, "assets", "roman-world-visual-proof-grid-nb2-2k.jpg");
const metadataPath = join(projectDir, "assets", "roman-world-visual-proof-grid-nb2-2k.json");
