...
const promptPath = join(
	projectDir,
	"prompts",
	"skeleton-engineer-character-sheet-v6-subtle-translucent-legs-prompt.txt",
);
const outputPath = join(
	projectDir,
	"assets",
	"characters",
	"skeleton-engineer-character-sheet-v6-subtle-translucent-legs-nb2-2k.jpg",
);
const metadataPath = join(
	projectDir,
	"assets",
	"characters",
	"skeleton-engineer-character-sheet-v6-subtle-translucent-legs-nb2-2k.json",
);
