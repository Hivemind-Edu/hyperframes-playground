...
const promptPath = join(projectDir, "prompts", "scene-reference-grid-v1-nb2-4k.txt");
...
const outputPath = join(projectDir, "assets", "scene-reference-grid-v1-nb2-4k.jpg");
const metadataPath = join(projectDir, "assets", "scene-reference-grid-v1-nb2-4k.json");
