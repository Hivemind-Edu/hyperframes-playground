...
const promptPath = join(projectDir, "prompts", "skeleton-engineer-character-sheet-v5-shorts-prompt.txt");
const outputPath = join(
	projectDir,
	"assets",
	"characters",
	"skeleton-engineer-character-sheet-v5-shorts-nb2-2k.jpg",
);
const metadataPath = join(
	projectDir,
	"assets",
	"characters",
	"skeleton-engineer-character-sheet-v5-shorts-nb2-2k.json",
);
